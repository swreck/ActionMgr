...
(Claude: update this section when the user describes the project.)

## Running the app

(Claude: update this section as the project is scaffolded — include exact commands for dev servers, builds, and tests.)
